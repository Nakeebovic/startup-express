...
### Fixed
- Added explicit `files` field in package.json to ensure README.md and all documentation files are included in npm package
- Resolved npm warning about missing README in published package

### Added
- Explicit package.json `files` field to include dist, README.md, CHANGELOG.md, LICENSE, and all documentation files

## [1.1.3] - 2025-12-07

### Fixed
- Improved TypeScript type declarations by using `express-serve-static-core` module augmentation instead of global namespace
- Enhanced compatibility with modern TypeScript projects and better IDE intellisense support

### Changed
- Updated Express Request type extension to follow TypeScript best practices
- Better type safety and declaration merging with Express types

## [1.1.2] - 2025-12-04

### Changed
- Updated package version for npm publication
- Ensured all documentation files are included in npm package
